...
**This tutorial was written for PHP 5.5 or newer versions.** If you are using a lower version, please upgrade it before you start. I recommend that you use the [current stable version](http://php.net/downloads.php).
